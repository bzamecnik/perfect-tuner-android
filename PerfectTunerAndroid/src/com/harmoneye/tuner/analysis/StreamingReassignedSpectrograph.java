...
//		sw.split();
//		Log.i("PerfectTuner", "transformFrame: " + sw.toSplitString());
//		sw.unsplit();
...
//		sw.split();
//		Log.i("PerfectTuner", "prev transformFrame: " + sw.toSplitString());
//		sw.unsplit();
...
//		sw.split();
//		Log.i("PerfectTuner", "cross spectra: " + sw.toSplitString());
//		sw.unsplit();
...
//		sw.split();
//		Log.i("PerfectTuner", "freqs: " + sw.toSplitString());
//		sw.unsplit();
...
//		sw.split();
//		Log.i("PerfectTuner", "second derivatives: " + sw.toSplitString());
//		sw.unsplit();
		
		magnitudeSpectrum = magnitudes(spectrum, magnitudeSpectrum);

//		sw.split();
//		Log.i("PerfectTuner", "magnitudes: " + sw.toSplitString());
//		sw.unsplit();
//		
...
//		sw.split();
//		Log.i("PerfectTuner", "reassignment: " + sw.toSplitString());
//		sw.unsplit();
		
//		StopWatch procSw = new StopWatch();
//		procSw.start();
...
//		sw.split();
//		Log.i("PerfectTuner", "postprocessing: " + sw.toSplitString());
//		sw.unsplit();
//		
...
//		sw.split();
//		Log.i("PerfectTuner", "wrap: " + sw.toSplitString());
//		sw.unsplit();

//		sw.stop();
//		Log.i("PerfectTuner", "computeChromagram(): " + sw.getTime() + " ms");
//		Log.i("PerfectTuner", "computeChromagram() - processing ratio: " + (100.0 * procSw.getTime() / sw.getTime()));
